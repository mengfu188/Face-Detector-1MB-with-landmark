...
{
    this->Pnet.load_param("../model/mtcnn/det1.param");
    this->Pnet.load_model("../model/mtcnn/det1.bin");
    this->Rnet.load_param("../model/mtcnn/det2.param");
    this->Rnet.load_model("../model/mtcnn/det2.bin");
    this->Onet.load_param("../model/mtcnn/det3.param");
    this->Onet.load_model("../model/mtcnn/det3.bin");
    this->Lnet.load_param("../model/mtcnn/det4.param");
    this->Lnet.load_model("../model/mtcnn/det4.bin");
}
